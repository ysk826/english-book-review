                    ...
                    <form onSubmit={handleSubmit} className="flex items-center">
                        <div className="relative w-full">
                            <input
                                ...
                                className="w-full pl-4 pr-10 py-2 text-sm border border-slate-200 rounded-lg bg-slate-50 focus:outline-none focus:ring-[2.5px] focus:ring-teal-600 focus:bg-white transition"
                            />
                            {query ? (
                                <button
                                    type="button"
